...
<head>
    ...
    <title>Editar Dieta - MuscleON</title>
    ...
    <main class="contenido-principal">
       <div class="contenedor">
            <div class="cabecera-guion">
                <h1><i class="fas fa-edit"></i>Editar dieta</h1>
            </div>
            <div class="form-contenedor">
                <form action="indice.php?ruta=actualizar_dieta&id=<?= $dieta["id"]?>" method="POST" class="formulario">
                   
                    <div class="grupo-formulario">
                        <label for="titulo" class="etiqueta-formulario">Titulo de la dieta: </label>
                      <input type="text" id="titulo" name="titulo" class="control-formulario" required value="<?= htmlspecialchars($dieta["titulo"])?>">
                    </div>

                    <div class="grupo-formulario">
                        <label for="descripcion" class="etiqueta-formulario">Descripcion de la dieta: </label>
                        <textarea  id="descripcion" name="descripcion" class="control-formulario" rows="6" placeholder="Describe tus objetivos, los alimentos que recomiendas...">
                            <?= htmlspecialchars($dieta["descripcion"] ??"")?>
                        </textarea>
                    </div>

                    <div class="grupo-formulario">
                        <label for="imagen_url" class="etiqueta-formulario">URL de la imagen (opcional) </label>
                        <input type="url" id="imagen_url" name="imagen_url" class="control-formulario" placeholder="https://ejemplo.com/mi-imagen.png" value="<?= htmlspecialchars($dieta["imagen_url"]??"")?>">
                    </div>
                    

                    <div class="grupo-formulario">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save"></i>Actualizar Dieta
                        </button>
